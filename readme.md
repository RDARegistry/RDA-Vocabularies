...
These are the [RDA](http://www.rdatoolkit.org/) [RDF vocabularies](http://en.wikipedia.org/wiki/Resource_Description_Framework#RDF_Vocabulary) maintained by volunteers and represenatatives of the [Joint Steering Committee for the Development of RDA](http://www.rda-jsc.org/). at the [Open Metadata Registry](http://metadataregistry.org).
